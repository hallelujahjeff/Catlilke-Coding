...
{
    private static List<GravitySource> sources = new List<GravitySource>(); //存储所有的重力源
    ...
    {
        Vector3 g = Vector3.zero;   //将所有重力源考虑在内
    ...
    public static Vector3 GetUpAxis (Vector3 position) //返回相机的up向量
    {
